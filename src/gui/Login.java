        ...
        btnaff.addActionListener((e)->{
            ...
            if(loggduser.getPassword().equals(pass.getText()))
            {
                ...
                if(loggduser.getRoles().equals("ROLE_CLIENT")){
                    Gui.allProduit EM = new Gui.allProduit();
                EM.getF().show();}
                else if(loggduser.getRoles().equals("ROLE_LIVREUR")){
                Gui.Leslivraisons EM = new Gui.Leslivraisons();
                EM.getF().show();
                }
                else if(loggduser.getRoles().equals("ROLE_MAGASIN"))
                        {
                        Gui.HomeForm EM = new Gui.HomeForm();
                        EM.getF().show();
                        }
